...
String getTagKeyword(int index) => (index <= 0 || index >= lKeywordsByIndex.length)
    ? null
    : lKeywordsByIndex[index];

int tagKeywordToIndex(String name) => binarySearch(sortedKeywords, name);

const List<String> lKeywordsByIndex = const [
